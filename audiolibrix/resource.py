...
class Book:
    def __init__(self, data={}):
        ...
        try:
            self.published_on = datetime.datetime.strptime(
...
class Order:
    ...
    def create(cls, books, order_id, user_email):
        data = {
            ...
            'Items': [book_id for book_id in books if isinstance(book_id, int)]
        }
    ...
    def get(cls, order_id):
        client = audiolibrix.http_client.Requestor()
        response = client.request(url='orderdetails',
                                  method='GET',
                                  attributes={'merchantOrderId': order_id},
